...
Create training and testing Data within the training data for cross validation.
...
```
The accuracy is 50.4%, try the next one.
...
```
The accuracy is 99.25%. The result is very good. Try the next one to see if any chance better.
...
```
The accuracy is 70.98%, not good as random forest.
